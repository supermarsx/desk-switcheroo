...
; #INTERNAL GLOBALS# ============================================
Global $__g_i18n_sLang = "en"
Global $__g_i18n_oStrings = 0    ; Scripting.Dictionary for current locale
Global $__g_i18n_oFallback = 0   ; Scripting.Dictionary for en.ini (always loaded)
Global $__g_i18n_sLocaleDir = ""

; #FUNCTIONS# ===================================================

; Name:        _i18n_Init
; Description: Loads locale files into memory. Always loads en.ini as fallback.
;              If $sLang is not "en", also loads <lang>.ini as primary.
; Parameters:  $sLang - ISO language code (e.g. "en", "pt-PT")
; Return:      True on success
Func _i18n_Init($sLang = "en")
    ...
    Local $sEnPath = $__g_i18n_sLocaleDir & "\en.ini"
...
;              Fallback: current locale -> en.ini -> $sDefault parameter.
...
Func _i18n_GetAvailable()
    ...
    WEnd
    FileClose($hSearch)
    If $sResult = "" Then $sResult = "en"
    Return $sResult
EndFunc

; Name:        _i18n_GetCurrent
; Description: Returns the current language code
; Return:      Language code string (e.g. "en", "pt-PT")
