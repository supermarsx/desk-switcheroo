...
Func _RunTest_i18n()
    ...
    _Test_AssertNotEqual("wl_search_tip exists", _i18n("WindowList.wl_search_tip", "MISSING"), "MISSING")
    _Test_AssertNotEqual("wl_empty exists", _i18n("WindowList.wl_empty", "MISSING"), "MISSING")
    ...
    _Test_AssertNotEqual("wl_goto exists", _i18n("WindowList.wl_goto", "MISSING"), "MISSING")
