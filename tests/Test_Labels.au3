...
Func _RunTest_Labels()
    ...
    _Labels_Save(4, "D")
    _Labels_Save(5, "E")
    Local $aMidSnap = _Labels_SnapshotLabels(5)
    _Labels_RemoveAndShift(3, 5, $aMidSnap)
    _Labels_InvalidateCache()
    ...
    _Labels_Save(2, "B")
    _Labels_Save(3, "C")
    Local $aEndSnap = _Labels_SnapshotLabels(3)
    _Labels_RemoveAndShift(3, 3, $aEndSnap)
    _Labels_InvalidateCache()
    ...
    _Labels_Save(2, "B")
    _Labels_Save(3, "C")
    Local $aFirstSnap = _Labels_SnapshotLabels(3)
    _Labels_RemoveAndShift(1, 3, $aFirstSnap)
    _Labels_InvalidateCache()
