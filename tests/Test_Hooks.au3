...
Func _RunTest_Hooks()
    ...
    $aParsed = __Hooks_ParseHookLine("on_slideshow_start", "cmd /c echo")
    _Test_AssertEqual("ParseLine: on_slideshow_start", $aParsed[0][0], "on_slideshow_start")
    $aParsed = __Hooks_ParseHookLine("on_slideshow_step", "cmd /c echo")
    _Test_AssertEqual("ParseLine: on_slideshow_step", $aParsed[0][0], "on_slideshow_step")
    $aParsed = __Hooks_ParseHookLine("on_slideshow_stop", "cmd /c echo")
    _Test_AssertEqual("ParseLine: on_slideshow_stop", $aParsed[0][0], "on_slideshow_stop")
    ...
    _Test_AssertTrue("ValidEvent: on_carousel_tick (deprecated, still fires)", __Hooks_IsValidEvent("on_carousel_tick"))
    _Test_AssertTrue("ValidEvent: on_slideshow_start", __Hooks_IsValidEvent("on_slideshow_start"))
    _Test_AssertTrue("ValidEvent: on_slideshow_step", __Hooks_IsValidEvent("on_slideshow_step"))
    _Test_AssertTrue("ValidEvent: on_slideshow_stop", __Hooks_IsValidEvent("on_slideshow_stop"))
