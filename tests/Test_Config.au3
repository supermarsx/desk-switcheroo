...
Func _RunTest_Config()
    ...
    _Test_AssertFalse("Default: move_here_click_enabled", _Cfg_GetMoveHereClickEnabled())
    ...
    $__g_Cfg_hSaveTimer = 0 ; bypass 500ms save debounce so this write actually lands
    _Cfg_Save()
    _Cfg_SetMoveHereClickEnabled(False)
    _Cfg_Load()
    _Test_AssertTrue("Persist: move_here_click_enabled survives reload", _Cfg_GetMoveHereClickEnabled())
    ...
    _Cfg_SetHotkeyMoveDesktopNext("^!]")
    _Test_AssertEqual("Set+Get: hotkey_move_desktop_next", _Cfg_GetHotkeyMoveDesktopNext(), "^!]")
    _Cfg_SetHotkeyMoveDesktopPrev("^![")
    _Test_AssertEqual("Set+Get: hotkey_move_desktop_prev", _Cfg_GetHotkeyMoveDesktopPrev(), "^![")
    ...
    _Cfg_SetMoveHereClickEnabled(True)
    _Test_AssertTrue("Set+Get: move_here_click_enabled", _Cfg_GetMoveHereClickEnabled())
    ...
    _Test_AssertEqual("Default: hotkey_move_desktop_next", _Cfg_GetHotkeyMoveDesktopNext(), "")
    _Cfg_SetHotkeyMoveDesktopNext("^!]")
    _Test_AssertEqual("Set+Get: hotkey_move_desktop_next", _Cfg_GetHotkeyMoveDesktopNext(), "^!]")

    _Test_AssertEqual("Default: hotkey_move_desktop_prev", _Cfg_GetHotkeyMoveDesktopPrev(), "")
    _Cfg_SetHotkeyMoveDesktopPrev("^![")
    _Test_AssertEqual("Set+Get: hotkey_move_desktop_prev", _Cfg_GetHotkeyMoveDesktopPrev(), "^![")
